...
from data_pipeline.loader import get_clean_data
...
async def run_simulation(params: SimulationParams):
    ...
    Returns:
        SimulationResponse with complete results
    """
    try:
        ...
        logger.info(f"Simulation complete. Final value: ${results['summary']['final_value']:,.2f}")
